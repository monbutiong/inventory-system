 ...
 <div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form method="post" id="frm_validation" action="<?php echo base_url('accounts/update_bsp_rate/'.$bsp_rate->id);?>" data-bs-toggle="validator" class="form-horizontal form-label-left">
          ...
          <!-- <?php 
          $rates = json_decode($bsp_rate->rate,TRUE);
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="bsp_rates[<?=$rs->id?>]" value="<?php echo @$rates[$rs->id]?>" class="form-control col-md-7 col-xs-12" required>
            </div>
          </div> 
          <?php }}}?> -->
