<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Accounts <small> Overhead Cost</small></h2> 
          ...
          <div class="input-group-btn pull-right" style="padding-right: 190px;">
              ...
              <a class="btn btn-sm btn-primary load_modal_details" href="<?php echo base_url('accounts/overhead_cost_add');?>" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg">Add Overhead Cost</a>
        ...
        <table id="datatable" class="table table-striped table-bordered table-hover">
          ...
          <thead>
            ...
            <tr>
              ...
              | 
              <a href="<?php echo base_url('accounts/overhead_cost_edit/'.$cid.'/'.$rs->id);?>" class="load_modal_details" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg"><i class="fa fa-edit"></i> edit</a>
...
function del_m(id){
  ...
  alertify.confirm("delete overhead cost information? this will permanently delete selected records.", function (e) {
        if (e) {  
            ...
            location.href = "<?php echo base_url();?>accounts/overhead_cost_delete/"+id;
        } else {
