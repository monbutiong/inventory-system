 ...
 <div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form method="post" id="frm_validation" action="<?php echo base_url('admin/update_project/'.$project->id);?>" data-bs-toggle="validator" class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select name="project_status_id" id="project_status_id" required="required" class="select2_ form-control">
                   ...
                   <option value="<?php echo $rs->id;?>" <?php if($rs->id==@$project->project_status_id){echo 'selected';}?>><?php echo $rs->title;?></option>
                   <?php }}?>
               </select> 
            </div>
          </div>  
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="selling_price" value="<?php echo @$project->selling_price?>" class="form-control col-md-7 col-xs-12">
            </div>
          </div> 
