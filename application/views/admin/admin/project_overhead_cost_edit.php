...
.vcc{
 ...
 <div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Project<small>Edit Overhead Cost for <?=@$pcn->control_number?></small></h2>
      ...
      <div class="x_content">
        <br />
        <form method="post" id="frm_validation" action="<?php echo base_url('admin/project_overhead_cost_update/'.$cid.'/'.@$oc->id);?>" data-bs-toggle="validator" class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <select name="overhead_cost_id" id="overhead_cost_id" required="required" class="select2_ form-control">
                   ...
                   <option value="<?php echo $rs->id;?>" <?php if($rs->id==$oc->overhead_cost_id){echo 'selected';}?>><?php echo $rs->title;?></option>
                   <?php }}?>
               </select> 
            </div>
          </div>  
          ...
          $oc_rate = json_decode($oc->rate, TRUE);
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="bsp_rates[<?=$rs->id?>]" value="<?=@$oc_rate[$rs->id]?>" class="form-control col-md-7 col-xs-12">
            </div>
          </div>   
          <?php }}}?>
