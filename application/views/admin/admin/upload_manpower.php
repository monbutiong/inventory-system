 ...
 <div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form method="post" target="_blank" id="frm_validation" action="<?php echo base_url('admin/upload_project_manpower/'.$p->id);?>"  class="form-horizontal form-label-left" enctype="multipart/form-data">
