...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Inventory <small>Add New BIB</small></h2>
      ...
      <div class="x_content">
        <br />
        <form method="post" id="frm_validation" action="<?php echo base_url();?>home/save_new_bib" data-bs-toggle="validator" class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="myInput" name="bib_name" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="bib_sn" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="device_number"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="package_type"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" name="pm_date" required="required" class="form-control col-md-7 col-xs-12" maxlength="4">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="socket_part_number"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="row">
                <div class="col-sm-4">
                  <input type="number" name="socket_density" min="1" class="form-control col-md-3">
                </div> 
                <div class="form-group col-sm-4 has-feedback"> 
                  <input type="number" name="socket_row" class="form-control col-md-3" placeholder=""> 
                  <span class="form-control-feedback right" aria-hidden="true">row</span>
                </div> 
                <div class="col-sm-4 has-feedback">
                  <input type="number" name="socket_column" class="form-control col-md-3" placeholder="">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="good_socket" required="required" class="form-control col-md-7 col-xs-12" >
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="defective_socket" required="required" class="form-control col-md-7 col-xs-12" >
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="date" name="date_uploaded" required="required" value="<?php echo date('Y-m-d')?>" class="form-control col-md-7 col-xs-12" >
            </div>
          </div>
