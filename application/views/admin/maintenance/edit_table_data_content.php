          ...
          <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <input type="text" id="ds" name="ds" value="<?=$table_data->ds?>" class="form-control col-md-7 col-xs-12"  <?php if($table_name=='fm_english_to_arabic'){ echo 'style="text-align: right;" dir="rtl"';}?>>
