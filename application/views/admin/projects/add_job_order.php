...
.vcc{
 ...
 <div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Project<small>Add Job Order</small></h2>
      ...
      <div class="x_content">
        <br />
        <form method="post" id="frm_validation" action="<?php echo base_url('projects/save_job_order');?>" data-bs-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
          
          <?php $c = $this->db->select('MAX(id) as c')->get('projects_job_order')->row();?>

          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Job Order No
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="job_order_number" value="JO<?=sprintf("%06d",($c->c + 1))?>" class="form-control col-md-7 col-xs-12 ridonly">
            </div>
          </div>  
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select type="text" name="quotation_id" onchange="load_quote(this.value)" class="form-control col-md-7 col-xs-12 select2">
                ...
                ?>
                <option value="<?=$rs->id?>"><?=$rs->quotation_number?></option>
                <?php }}?>
              </select>
            </div>
          </div>  
