...
.vcc{
 ...
 <div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Supplier<small>Edit Supplier</small></h2>
      ...
      <div class="x_content">
        <br />
        <form method="post" id="frm_validation" action="<?php echo base_url('purchasing/update_supplier/'.$supplier->id);?>" data-bs-toggle="validator" class="form-horizontal form-label-left">
