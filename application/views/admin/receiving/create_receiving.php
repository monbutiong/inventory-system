...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Receiving <small>Create GRV</small></h2> 
 
          <div class="input-group-btn pull-right" style="padding-right: 110px;">
                  <a class="btn btn-sm btn-primary" href="Javascript:save_receiving()"  >Save Receiving</a>
              </div>
        ...
        <table id="pos_table" class="table table-striped table-bordered table-hover">
          ...
          <thead>
            ...
            <tr id="recieve_section">
              ...
              <td colspan="12">
                <a id="add_items_btn" class="btn btn-sm btn-primary load_modal_details" href="<?php echo base_url('receiving/load_supplier_po_items');?>" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg" > Add Receive Items </a>
              </td>
