 <div class="row">
  <div class="col-md-6 col-sm-8 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
      <form method="post" id="frm_gen_report" name="frm_gen_report" target="_blank" action="<?php echo base_url();?>reports/generate_inventory_movement" data-bs-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
