 ...
 <div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form method="post" id="frm_validation" action="<?php echo base_url('sales/update_tnc/'.$tnc->id);?>" data-bs-toggle="validator" class="form-horizontal form-label-left">
          ...
          <div class="form-group" >
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  -->
                                 ...
                                 <div id="editor-one" class="editor-wrapper2" onkeyup="repli()"><?=$tnc->description?></div>

                                 <textarea name="terms_and_conditions" id="terms_and_conditions" style="display:none;"><?=$tnc->description?></textarea>
