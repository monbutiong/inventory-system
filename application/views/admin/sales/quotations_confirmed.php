<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Sales <small>Confirmed Quotation List</small></h2> 
          ...
          <thead>
            ...
            <tr>
              ...
              <td nowrap>
                ...
                <!-- <a href="<?php echo base_url('sales/quotation_status/'.$rs->id);?>"><i class="fa fa-file-text-o"></i> Status</a>
                 |  -->
                <a href="<?php echo base_url('sales/quotation_history/'.$rs->id);?>" ><i class="fa fa-history"></i> History</a>
                 | 
                <a href="<?php echo base_url('sales/view_quotation/'.$rs->id);?>" ><i class="fa fa-file-text-o"></i> View</a>
                 | 
                <a href="<?php echo base_url('sales/view_quotation_status/'.$rs->id);?>" ><i class="fa fa-list-ul"></i> Status</a>
                <!--  |  
