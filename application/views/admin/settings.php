<div class="col-md-6 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      <br />
      <form method="post" action="<?php echo base_url('home/settings_update');?>" class="form-horizontal form-label-left input_mask" data-bs-toggle="validator">
        ...
        <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12">Asset Depriciation Cutoff </label>
          <div class="col-md-9 col-sm-9 col-xs-12">
            
            <select class="form-control" required="required" name="depriciation_cutoff" id="depriciation_cutoff">
            <?php if($settings->depriciation_cutoff==1){?>
            	<option value="1">include asset recorded at 1st day cutoff</option>
            	<option value="0">include asset recorded at 15th day cutoff</option>
            <?php }else{?>
            	<option value="0">include asset recorded at 15th day cutoff</option>
            	<option value="1">include asset recorded at 1st day cutoff</option>
            <?php }?>
