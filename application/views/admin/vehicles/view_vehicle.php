  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="modal-header">
          <h5 class="modal-title" id="mySmallModalLabel">View Vehicle</h5>
      ...
      <div class="modal-body">
        <br />
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" readonly name="plate_no" onblur="check_plate(this.value)" value="<?php echo @$vehicle->plate_no?>" class="form-control col-md-7 col-xs-12">
            </div>
          </div>  
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" readonly name="vin" onblur="check_vin(this.value)" value="<?php echo @$vehicle->vin?>" class="form-control col-md-7 col-xs-12">
            </div>
          </div>  
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select readonly onchange="load_only_selected_manu(this.value)" name="manufacturer_id" class="form-control col-md-7 col-xs-12 select2">
             
            	<?php 
            	if(@$manufacturers){
            		foreach($manufacturers as $rs){ if($vehicle->manufacturer_id==$rs->id){
            	?>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" id="load_models">
              <select readonly id="vehicle_model_id" name="vehicle_model_id" class="form-control col-md-7 col-xs-12 select2">
               
              	<?php 
              	if(@$models){
              		foreach($models as $rs){ 
              			if($vehicle->vehicle_model_id==$rs->id){
              	?>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select readonly name="customer_id" class="form-control col-md-7 col-xs-12 select2"> 
              	<?php 
              	if(@$customers){
              		foreach($customers as $rs){ if($vehicle->customer_id==$rs->id){
              	?>
